...
<div id="profilePic">
  ...
  <a href="changeImage.php"> <button>Change Image</button></a>
    ...
    <?php if (isset($_REQUEST['id'])) {
        ...
        $is_friend = $user-> get_friend($user_id,$request_id);
        ?>
            <?php if($is_friend){ ?>
            <a href="unfriend.php?friend_id=<?= $request_id ?>">Remove as friend</a>
            <?php }else{ ?>
            <a href="friend.php?friend_id=<?= $request_id ?>">Add as Friend</a>
            <?php } ?>
    <?php } ?>
<div id='main'>
<div id='side'>
